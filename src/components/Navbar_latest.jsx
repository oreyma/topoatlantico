...
<nav
  ...
  } font-semibold ${scrolled ? "text-topo-navy" : "text-topo-navy"}`}
>
  <a href="#services" className="hover:text-[#2DD4BF] transition-colors">
    Servicios
  </a>
  <a href="#projects" className="hover:text-[#2DD4BF] transition-colors">
    Proyectos
  </a>
  <a href="#about" className="hover:text-[#2DD4BF] transition-colors">
    Nosotros
  </a>
  <a href="#contact" className="hover:text-[#2DD4BF] transition-colors">
    Contacto
  </a>
